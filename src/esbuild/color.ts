...
export function createColorGetterFormats<T>(tree: TreeNode<T>, metafile: Metafile): (node: TreeNode<T>) => ColorValue | undefined {
  const colorMapping: ColorMapPlain = {}
  assignColorsByFormat(colorMapping, tree, metafile)
